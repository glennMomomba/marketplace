...
<div class="container mx-auto max-w-md mt-12 bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
    <h2 class="text-2xl font-bold text-center text-red-600 mb-6">🔑 Réinitialiser le mot de passe</h2>
    ...
    <form method="POST" action="{{ route('password.update') }}">
        ...
        <div class="mb-4">
            ...
            <input id="email" type="email" name="email" value="{{ old('email') }}" required
                class="w-full border rounded px-3 py-2 focus:ring focus:ring-red-300">
        </div>
